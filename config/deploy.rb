...
after "deploy:assets:symlink", "mystro:config:update"
after "deploy:assets:symlink", "mystro:chef:update"
after "deploy:assets:symlink", "mystro:volley:update"
after "deploy:assets:symlink", "mystro:mcollective:update"
